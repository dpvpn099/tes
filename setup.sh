...
run_ei() {
  ...
  # Link izin IP VPS
  url_izin='https://raw.githubusercontent.com/Tikusmerdeka/v5/main/izin.txt'
...
clear
      ...
      echo -e ""
      echo -e "\e[93m Telegram\e[32;1m : https://t.me/KangSantri"
      echo -e "\e[33m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | lolcat
      echo -e ""
      exit 0
    fi
...
rm -fr menu
rm -fr /usr/sbin/menu
wget https://raw.githubusercontent.com/Tikusmerdeka/v5/main/menu.zip
unzip menu.zip
chmod +x menu/*
...
#######service
cd /usr/local/bin
wget https://raw.githubusercontent.com/Tikusmerdeka/v5/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
...
wget https://raw.githubusercontent.com/Tikusmerdeka/v5/main/service.zip
unzip service.zip
rm -fr service.zip
...
mkdir /etc/slowdns
cd /etc/slowdns
wget https://raw.githubusercontent.com/Tikusmerdeka/v5/main/dns.zip
unzip dns.zip
chmod +x *
...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/Tikusmerdeka/v5/main/password"
...
wget -O /etc/nginx/conf.d/xray.conf https://raw.githubusercontent.com/Tikusmerdeka/v5/main/xray.conf
...
<font color="red"><b>********  KangSantri VPN  ********</b></font><br>
<font color="blue"><b>===============================</br></font><br>
END
...
wget -O /etc/xray/config.json https://raw.githubusercontent.com/Tikusmerdeka/v5/main/config.json
